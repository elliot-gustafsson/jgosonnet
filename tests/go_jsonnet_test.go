...
func Test_go_jsonnet_import_failure_directory(t *testing.T) {
	...
	expected := `RUNTIME ERROR: failed importing file: /workspace/tests/resources/go-jsonnet/testdata, err: read /workspace/tests/resources/go-jsonnet/testdata: is a directory
