...
func Test_jsonnet_error_import_empty(t *testing.T) {
	...
	expected := `RUNTIME ERROR: failed importing file: /workspace/tests/resources/jsonnet-cpp/test_suite, err: read /workspace/tests/resources/jsonnet-cpp/test_suite: is a directory
